...
//             FROM holdings h
//             INNER JOIN market_stocks_data s ON h.instrument_key = s.instrument_key
...
//             const totalReturn = current - investment;

//             const totalReturnPercent = investment > 0 ? (totalReturn / investment) * 100 : 0;

//             const dayPnL = Number(stock.change_value) * Number(stock.quantity);
//             const averagePrice = investment / Number(stock.quantity);



//             const previousClose = Number(stock.current_price) - Number(stock.change_value);
//             const previousHoldingValue = previousClose * Number(stock.quantity);

//             totalPreviousValue += previousHoldingValue;
//             todaysPnL += dayPnL;

//             const todaysReturnPercent = totalPreviousValue > 0 ? (todaysPnL / totalPreviousValue) * 100 : 0;
...
//                 day_change_value: Number(stock.change_value),
//                 day_pnl: dayPnL,
...
//                 totalReturnPercent: totalInvestment > 0 ? ((currentValue - totalInvestment) / totalInvestment) * 100 : 0,
//                 todaysPnL,
//                 todaysReturnPercent
//             },
//             holdings

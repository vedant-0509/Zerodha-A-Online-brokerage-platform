...
//     //     console.log("Refreshing Friday change values...");

//     //     await db.execute(`
//     //     UPDATE market_gainerloser
//     //     SET
//     //         change_points = ROUND(close_price - previous_close,2),
//     //         change_percent = ROUND(((close_price - previous_close) / previous_close) * 100, 2)
//     //     WHERE previous_close > 0
//     //     `);

//     //     console.log("Showing previous trading day's data.");
//     //     return;
//     // }
...
//     console.log("\nPrevious Close updated for tomorrow.");
...
// // ONE-TIME-PER-DAY UPDATE, ONLY AFTER 3:35 PM, ONLY ON WEEKDAYS
...
//     // Before market closes -> yesterday
//     if (now.getHours() < 15 || (now.getHours() === 15 && now.getMinutes() < 35)) {
...
//         if (await hasAlreadyRunToday(todayStr)) return;

//         console.log(`\n[${todayStr}] Running post-3:35PM market update...`);

//         const previousTradingDay = await getPreviousTradingDay();
//         console.log("Previous Trading Day:", previousTradingDay);

//         await updatePreviousClose(previousTradingDay);
//         await fetchNews();
...
//     setInterval(checkAndRunDailyUpdate, 60000);

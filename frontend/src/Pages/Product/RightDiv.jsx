...
export default function rightDiv({ url, name, desc, gplay, appStore, margin }) {
    return (
        <>
            <div style={{ display: "flex", justifyContent: "space-evenly", alignItems: "center", marginBottom: "4rem", marginLeft: "3rem", marginTop: margin, marginBottom: margin }}>
                ...
                <div style={{ width: "40rem", height: "auto", textAlign: "center" }}>
                    <img src={`/images/${url}`} className="logo" style={{ width: "100%", height: "100%" }} />
                </div>
            </div>
        </>
    );
